...
pkg update
pkg install -y git zsh micro lsd neofetch
git clone https://github.com/Virkkunen/termux.git "$HOME/termux-vrkknn" --depth 1

mv "$HOME/.termux" "$HOME/.termux.bak.$(date +%Y.%m.%d-%H:%M:%S)"
cp -R "$HOME/termux-vrkknn/.termux" "$HOME/.termux"
